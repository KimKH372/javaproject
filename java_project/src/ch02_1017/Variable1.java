...
public class Variable1 {
	...
	public static void main(String[] args) {
		...
		// 초기화 : 최초 변수에 값을 할당 하는 것을 말함.
		byte b1 = 12; // 변수를 선언과 동시에 값을 할당.
		
		// 기본 데이터 타입 primitive type,
		// 기본 타입을 제외한 나머지를 참조형 타입. (주로 참조형을 많이 사용)
		// 참조형 타입 : 클래스 타입.
		// class Person
		// 참조형 타입으로 선언하게 되면,
		// Person p1; 선언 만.
		...
		System.out.println("내용 테스트");
		System.out.println("단축키 설정 완료");
		System.out.println("간혹 단축기 실행 안된다면 설정에서 추가");
		//참고 블로그 사이트 
