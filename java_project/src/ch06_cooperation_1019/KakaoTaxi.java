...
public class KakaoTaxi {
	...
	int kakaotaxiNumber;             // 버스 번호
	 ...
	 public KakaoTaxi(int kakaotaxiNumebr)   // 버스 번호를 매개변수로 받는 생성자
	 {   
		  this.kakaotaxiNumber = kakaotaxiNumebr;
	 }
	 ...
	 public void showInfo() {      // 버스 정보를 출력하는 함수
		  System.out.println("택시 " + kakaotaxiNumber + "번 차량의 승객은 " + passengerCount +"명이고, 수입은 " + money + "입니다.");
	 }
